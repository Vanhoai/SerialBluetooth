...
object SerialBluetoothAppTheme {
 ...
 * [backgroundColor] is [SerialBluetoothColors.uiBackgroundPrimary], this will return [SerialBluetoothColors.textSecondary].
 *
...
fun SerialBluetoothColors.contentColorForGradient(): Color = textSecondary
...
fun contentColorFor(backgroundColor: Color) =
    SerialBluetoothAppTheme.colors.contentColorFor(backgroundColor)
